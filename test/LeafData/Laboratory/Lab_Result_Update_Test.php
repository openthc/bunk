...
class Lab_Result_Update_Test extends \OpenTHC\Bunk\Test\LeafData_Test
{
	...
	public function test_update_lab_result()
	{
		...
		$lrc = new Lab_Result_Create;
		$lrc->setUp();
		// $lrc->test_create_lab_result();
		$lrc->test_harvest_material_flower_lots();
		$Result = $_ENV['Result'];
		var_dump($lrc);
